       ...
       <table>
        ...
        <td> 
                            ...
                            <?php if(isset($row['Image2']) && !empty($row['Image2'])): ?>
                                <img src="uploads/<?php echo $row['Image2']; ?>" alt="" height='150' width='150'><br>
                                <a href="delproduImg.php?id=<?php echo $row['blogID'];?>">Delete Image</a><br>
                            <?php else: ?>
                                <div class="form-group">
                                    <label for="productimage2">Product Image</label>
                                    <input type="file" name="productimage2" id="productimage">
                            ...
                            <td> <?php if(isset($row['Image3']) && !empty($row['Image3'])): ?>
                                <img src="uploads/<?php echo $row['Image3']; ?>" alt="" height='150' width='150'><br>
                                <a href="delproduImg.php?id=<?php echo $row['blogID'];?>">Delete Image</a><br>
                            <?php else: ?>
                                <div class="form-group">
                                    <label for="productimage3">Product Image</label>
                                    <input type="file" name="productimage3" id="productimage">
                                    <p class="help-block">Only jpg/png are allowed.</p>
                                </div>
                            <?php endif; ?>
                            </td>
                           ...
                           <?php if(isset($row['Image4']) && !empty($row['Image4'])): ?>
                                <img src="uploads/<?php echo $row['Image4']; ?>" alt="" height='150' width='150'><br>
                                <a href="delproduImg.php?id=<?php echo $row['blogID'];?>">Delete Image</a><br>
                            <?php else: ?>
                                <div class="form-group">
                                    <label for="productimage4">Product Image</label>
                                    <input type="file" name="productimage4" id="productimage">
                                    <p class="help-block">Only jpg/png are allowed.</p>
                                </div>
                            <?php endif; ?>
                        </td>
                            ...
                            <td>
                                ...
                                <img src="uploads/<?php echo $row['Image5']; ?>" alt="" height='150' width='150'><br>
                                <a href="delproduImg.php?id=<?php echo $row['blogID'];?>">Delete Image</a><br>
                            <?php else: ?>
                                <div class="form-group">
                                    <label for="productimage5">Product Image</label>
                                    <input type="file" name="productimage5" id="productimage">
                                    <p class="help-block">Only jpg/png are allowed.</p>
                                </div>
                            <?php endif; ?></td>
                                ...
                                <img src="uploads/<?php echo $row['Image6']; ?>" alt="" height='150' width='150'><br>
                                <a href="delproduImg.php?id=<?php echo $row['blogID'];?>">Delete Image</a><br>
                            <?php else: ?>
                                <div class="form-group">
                                    <label for="productimage6">Product Image</label>
                                    <input type="file" name="productimage6" id="productimage">
                                    <p class="help-block">Only jpg/png are allowed.</p>
                                </div>
                            <?php endif; ?></td>
                            </tr></table>
