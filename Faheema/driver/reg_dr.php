...
if(isset($_POST['regbtn'])){
  ...
  $targetFile2 = $targetDire . basename($_FILES["veh"]["name"]);
  move_uploaded_file($_FILES["veh"]["tmp_name"], $targetFile2);
  ...
  $i="insert into driver(firstname, lastname, gender, phone, address,veh_des, vehicle, picture, experience, nic, email, password, location, license, qualification)values ('$f','$l','$g','$p','$a','$v','$targetFile2','$targetFile1','$e', '$n','$ema','$password','$lo','$targetFile3', '$q')";
  if(mysqli_query($con, $i)){
	$msg = "Account created";
	header("Location: drvr.php?warning=" . urlencode($msg));
	exit();
  }
}
?>
<!DOCTYPE html>
<head>
    <link rel="stylesheet" href="registrd.css">
    <title></title>
</head>
<body>
    ...
    <table>
        <tr> 
            ...
            <td width="450px">
                ...
                <div class="container-right">
                    <br><br><br><label for="phoneNo"><b>NIC No </b></label><br>
        ...
        <tr><td colspan="2">
            <hr>
                   ...
                   <div class="latter">
                    <button type="submit" class="registerbtn" name="regbtn"><b>Register</b></button>
                </div>
                  </div>
        </td>
        <td></td></tr>
