...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['languagePreference'] = $_POST['languagePreference'];
   ...
   // Prevent default form submission behavior
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var daysInputHalfDay = document.getElementById('checkInOutHalfDay');
            var daysInputFullDay = document.getElementById('checkInOutFullDay');
            ...
            var nextButton = document.querySelector('[onClick="validate(this)"]');
            nextButton.addEventListener('click', function() {
                if (hourlyRadio.checked || halfDayMorningRadio.checked || halfDayAfternoonRadio.checked) {
                    if (!document.getElementById('time').value) {
                        alert('Please fill all fields.');
                        return;
                    }
                }
                // Code to move to the next section of the wizard
            });
        });
    </script>
