...
<?php
  $sql_allReview = "SELECT * FROM reviews JOIN user_data ON user_data.userid=reviews.uid";
...
<h6 class="uppercase space20">Add a review</h6>
                                 ...
                                 if(isset($_SESSION['customerid'])){
                                    $c_id = $_SESSION['customerid']; 
                                    $sql_nameEmail = "SELECT user.email, user_data.firstname, user_data.lastname FROM user JOIN user_data ON user.id=user_data.userid AND user_data.userid = '$c_id'";
