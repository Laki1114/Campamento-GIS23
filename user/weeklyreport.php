...
// Query to retrieve weekly purchases for the user
$sql = "SELECT
            o.id AS order_id,
...
if (mysqli_num_rows($result) > 0) {
    ...
    <head>
        ...
        <title>Weekly Purchases Report</title>
        <link rel="stylesheet" type="text/css" href="../css/style.css"> <!-- Adjust the path to your CSS file -->
    </head>
    <body>
        <h1>Weekly Purchases Report</h1>
        <table>
            <thead>
                <tr>
                    <th style="padding: 15px;">Order ID</th>
                    <th style="padding: 15px;">Date</th>
                    <th style="width: 50px;"></th> <!-- Add an empty column with a defined width -->
    ...
    echo "No purchases found for this week.";
}
?>