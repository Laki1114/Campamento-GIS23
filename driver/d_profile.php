    ...
    if(isset($_FILES["new_image"]) && $_FILES["new_image"]["error"] == 0){
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["new_image"]["tmp_name"], $target_file)) {
                ...
                $sql = "UPDATE driver SET picture='$new_image_path' WHERE d_id='$id'";
...
<table style="width: 70%; border: 1px solid black;">
      ...
      <tr>
        <td style="padding: 10px; text-align: left; border: 1px solid black;">Vehicle Type</td>
         <td style="padding: 10px; text-align: left; border: 1px solid black;"><?php echo $row['Vehicle_type']; ?></td>
        </tr>
        <tr>
        <td style="padding: 10px; text-align: left; border: 1px solid black;">Model</td>
        <td style="padding: 10px; text-align: left; border: 1px solid black;"><?php echo $row['Model']; ?></td>
        </tr>
        <tr>
        <td style="padding: 10px; text-align: left; border: 1px solid black;">A/C or Non A/C</td>
        <td style="padding: 10px; text-align: left; border: 1px solid black;"><?php echo $row['AC']; ?></td>
        </tr>
        <tr>
        <td style="padding: 10px; text-align: left; border: 1px solid black;">Vehicle Description</td>
        <td style="padding: 10px; text-align: left; border: 1px solid black;"><?php echo $row['veh_des']; ?></td>
        </tr>
...
<br><br>
  ...
  <div class="v-desc">
   ...
   <p> <?php echo $row['experience']; ?>
</p>
<button class="edit-v"> <a href="editVeh.php">Edit Details</a></button><br><br>
